package com.srhiri.cinema.services;
...
import com.srhiri.cinema.dao.*;
import com.srhiri.cinema.repositories.*;
...
public class CinemaInitServiceImpl implements ICinemaInitService {
    ...
    public void initVilles() {
        Stream.of("Casa", "Oujda", "Agadir", "Marrakech").forEach(nameVille -> {
    ...
    public void initCinema() {
        villeRepository.findAll().forEach(v -> {
            Stream.of("CINEMA1", "CINEMA2", "CINEMA3", "CINEMA4", "CINEMA5")
                    .forEach(nameCinema -> {
